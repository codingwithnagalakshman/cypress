describe("upload file", () => {
    ...
    it("upload file", () => {
        ...
        cy.location('pathname').then( urlPath => {
            ...
            cy.downloadFile('https://opensource-demo.orangehrmlive.com/web/index.php/recruitment/viewCandidateAttachment/candidateId/'+candidateId, 'cypress/fixtures', 'resume.txt')
